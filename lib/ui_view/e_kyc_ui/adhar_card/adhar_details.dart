...
class AdharCardDetails extends StatefulWidget {
  const AdharCardDetails({super.key});

  @override
  State<AdharCardDetails> createState() => _AdharCardDetailsState();
}

class _AdharCardDetailsState extends State<AdharCardDetails> {
  @override
  void initState() {
                        ...
                        child: IntrinsicHeight(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text(
                                valustate.kycData?.data?.aadharNo??"",
