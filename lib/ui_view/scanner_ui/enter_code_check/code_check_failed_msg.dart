...
class CodeCheckFailedScreen extends StatefulWidget {
  String msg,point,status,codtype,code,codedate;
  CodeCheckFailedScreen({
    required this.msg,
    required this.point,
  ...
  @override
  State<CodeCheckFailedScreen> createState() => _CodeCheckFailedScreenState();
}

class _CodeCheckFailedScreenState extends State<CodeCheckFailedScreen> {
  @override
  void initState() {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: TextButton(
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>RaisedTicketScreen(ticketType: "Code Check Failed ${widget.code}")));
                          },
                          child: Text(
                            "Issue Report",
                            style: TextStyle(
